...
(defgroup doom-breeze-dark-theme nil
  "Options for the `doom-breeze-dark' theme."
  :group 'doom-themes)

(defcustom doom-breeze-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-breeze-dark-theme
  :type 'boolean)

(defcustom doom-breeze-dark-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-breeze-dark-theme
  :type 'boolean)

(defcustom doom-breeze-dark-comment-bg doom-breeze-dark-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-breeze-dark-theme
  :type 'boolean)

(defcustom doom-breeze-dark-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-breeze-dark
  ...
  (
   ...
   ;; (syntax-keyword     '("#f67400" "orange"  "orange" ))
   (syntax-keyword  '("#62b29b" "green"  "green" ))
   ;; (syntax-special  '("#ffe6b3" "yellow"  "yellow" ))
   (syntax-special     '("#ffa759" "orange"  "orange" ))
   (syntax-comment  '("#5c6773" "grey"    "grey"   ))
   ;; (syntax-constant '("#d4bfff" "magenta" "purple" ))
   ;; (syntax-constant '("#d48fff" "magenta" "purple" ))
   ;; (syntax-constant   '("#bae67e" "green"   "green"  ))
   ;; (syntax-constant   '("#7ee5c8" "green"   "green"  ))
   (syntax-constant   '("#62b2af" "green"   "green"  ))
   ...
   (selection      nil)
   (builtin        nil)
   (comments       (if doom-breeze-dark-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-breeze-dark-brighter-comments dark-cyan base5) 0.25))
   ...
   ;; custom categories
   (hidden     (car bg))
   (-modeline-bright doom-breeze-dark-brighter-modeline)
   (-modeline-pad
    (when doom-breeze-dark-padded-modeline
      (if (integerp doom-breeze-dark-padded-modeline) doom-breeze-dark-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base4)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-breeze-dark-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; doom-breeze-dark-theme.el ends here
